    ...
    <div className="flex flex-col min-w-screen min-h-screen">
      <div className="flex flex-col justify-start 2xl:gap-8 mt-24 h-screen md:mt-4 gap-2">
        <Image
          ...
          width={460}
          height={300}
          className="min-w-[50%] self-center z-0 rounded-md"
        />
        <div className="flex flex-col gap-0 w-full lg:w-[70%] self-center px-2 md:mt-0 md:px-16 md:justify-center">
          ...
          <h1 className="text-2xl 2xl:text-3xl font-bold mb-8 mt-8 text-center md:text-start">
            {title}
          </h1>
          <h2 className="text-center text-md lg:text-xl">{subtitle}</h2>
        </div>
      </div>
